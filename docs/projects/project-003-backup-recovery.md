...
| Item | Candidate location or method | Status |
| --- | --- | --- |
...
| Prometheus service definition | `systemctl show prometheus` | Pending |
| Blackbox Exporter service definition | `systemctl show prometheus-blackbox-exporter` | Pending |
...
| Grafana dashboards | Dashboard JSON export | Pending |
| Grafana Prometheus data source | Grafana UI and state review | Pending |
| Node Exporter service definition | `systemctl show prometheus-node-exporter` | Pending |
...
4. Restore or recreate reviewed Prometheus and Blackbox Exporter configuration.
5. Recreate the Grafana Prometheus data source.
6. Import reviewed dashboard JSON.
7. Validate service states, Prometheus targets, required PromQL queries, DNS probes, and Grafana panels.
